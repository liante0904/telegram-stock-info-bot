...
async def theme_quant(update: Update, context: CallbackContext) -> None:
    keyboard = [
        [InlineKeyboardButton("테마 퀀트 시작하기", callback_data='start_theme_quant')],
        [InlineKeyboardButton("테마 등록하기", callback_data='register_theme_quant'),
         InlineKeyboardButton("테마 편집하기", callback_data='edit_theme_quant')]
    ]
    
    reply_markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text('원하는 작업을 선택하세요:', reply_markup=reply_markup)
...
def main():
    ...
    application.add_handler(CommandHandler("theme_quant", theme_quant))  # theme_quant 명령어 추가
